...
IMZML_TEMPLATE = """\
@require(uuid, sha1sum, mz_data_type, int_data_type, pixel_size_x, pixel_size_y, start_index, run_id, spectra, mode, obo_codes, obo_names, mz_compression, int_compression, polarity, spec_type, scan_direction, scan_pattern, scan_type, line_scan_direction)
